    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden"
      ...
      >
        ...
        <div className="relative backdrop-blur-xl rounded-3xl border border-white/10 overflow-hidden"
          ...
          {/* Card glow */}
          <div className="absolute -top-32 -left-32 w-64 h-64 bg-purple-500/30 rounded-full blur-[80px] pointer-events-none" />
          <div className="absolute -bottom-32 -right-32 w-64 h-64 bg-cyan-500/30 rounded-full blur-[80px] pointer-events-none" />
